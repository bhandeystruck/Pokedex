...
export default class Pokemon extends Component {
    ...
    async componentDidMount(){
        //we get the index of the pokemon from the parameters passed in it
        const {pokemonIndex} = this.props.match.params;
        //set url for pokemon information
        const pokemonUrl = `https://pokeapi.co/api/v2/pokemon/${pokemonIndex}/`;

        const pokemonSpeciesUrl = `https://pokeapi.co/api/v2/pokemon-species/${pokemonIndex}`;

        //get poke information
        ...
        //get the pokemon description, catch Rate, EggGroups, Gender Ratio, Hatch Steps
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="row mt-5">
                  <div className="col">
                    <h3 className="">{this.state.description}</h3>
                  </div>
                </div>
              </div>
              <hr />
